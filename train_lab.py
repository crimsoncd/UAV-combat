...
def train_Half(env, actor_lr=2.5e-4, critic_lr=1e-3, episodes=3000, max_steps=200, batch_size=256, is_render=False, task_code="test", display=False):
...
if __name__ == "__main__":
    ...
    task_code = "15_lab_server_Rewardtest_b"
